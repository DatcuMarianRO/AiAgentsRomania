...
const AgentsMarketplace: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="py-32 px-4 sm:px-6 lg:px-8 bg-gray-900">
...
const AgentCard: React.FC<{ agent: Agent; index: number }> = ({ agent, index }) => {
  ...
  return (
    <div 
      ref={cardRef}
      className="relative bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 hover:border-gray-600 transition-all duration-300 group cursor-pointer"
    >
      {/* Header */}
